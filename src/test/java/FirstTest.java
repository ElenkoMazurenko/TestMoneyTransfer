...
//проверка перевода
        Selenide.$$("[data-qa-node=\"payer-card\"]").shouldHave(CollectionCondition.itemWithText("4552 3314 4813 8217"));
        Selenide.$$("[data-qa-node=\"payer-amount\"]").shouldHave(CollectionCondition.itemWithText("123 USD"));
        Selenide.$$("[data-qa-node=\"receiver-card\"]").shouldHave(CollectionCondition.itemWithText("4004 1591 1544 9003"));
